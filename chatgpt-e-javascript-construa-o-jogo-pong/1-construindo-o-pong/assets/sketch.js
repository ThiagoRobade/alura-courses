...
function preload() {
    ...
    bolaImg = loadImage('./assets/sprites/bola.png');
    barra1Img = loadImage('./assets/sprites/barra01.png');
    barra2Img = loadImage('./assets/sprites/barra02.png');
    bounceSound = loadSound('./assets/sound/bounce.wav');
    golSound = loadSound('./assets/sound/gameover.wav');
}
